                                        ...
                                        <table class="table table-bordered table-nowrap align-middle mb-0">
                                            ...
                                            <?php if (!empty($countries)) : ?>
                                                <?php foreach ($countries as $country) : 
                                                    $currency_code=esc($country['currency_code']);
                                                    $country_name=esc($country['country']);
                                                    $date=date('Y-m-d');
                                                    ?>
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <input class="form-control" type="text" name="conversion_rate[]" value="<?php echo $currencyModel->getCurrencyRate($country_name,$date);?>" />
